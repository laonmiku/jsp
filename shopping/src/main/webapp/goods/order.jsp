	...
	<div class="row justify-content-center my-5">
		<div class="col-10 col-md-8 ">
			<div class="card">
				...
				<div class="card-body ">
					<form name="frm" class="justify-content-center">
						<div class="input-group mt-2">
							<span class="input-group-text w-25 justify-content-center">주문자명</span>
							<input name="rname" class="form-control" value="${user.uname}">
						</div>
						<div class="input-group mt-2">
							<span class="input-group-text w-25 justify-content-center">전화번호</span>
						...
						<div class="input-group mt-2 ">
							...
							<button class="btn btn-light border w-25">검색</button>
						</div>
						<div>
							<input name="raddress2" class="form-control mt-2" placeholder="상세주소"  value="${user.address2}">
						</div>
