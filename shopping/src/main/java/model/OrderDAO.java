...
public class OrderDAO {//카트써블릿
	...
	public ArrayList <PurchaseVO> list (QueryVO query){
		...
		try {
			...
			System.out.println("모든 주문목록 : "+e.toString());
		}
		return array;
	} 
	...
	public ArrayList <OrderVO> olist (String pid){
		...
		try {
			...
			System.out.println("주문의 상품목록 : "+e.toString());
		}
		return array;
	};
	...
	//주문상품등록
		public void insert (OrderVO vo) { 
			try {
				...
				System.out.println("주문상품정보 등록 : "+e.toString());
			}
		}
	...
	public void insert (PurchaseVO vo) { 
		try {
			...
			ps.setString(3, vo.getUname()); //익스텐드했으니 uname임!
