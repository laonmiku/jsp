	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<input id="uname" class="form-control md-1" placeholder="이름" value="${user.uname}">
				<input id="phone" class="form-control  md-1" placeholder="전화번호" value="${user.phone}">
        	<div class="input-group mb-1">
	        	<input id="address1" class="form-control  md-1" value="${user.address1}">
